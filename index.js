...
//This is possible because of closure, a nested function can reach out of its scope and grab variables to use itself but the opposite wouldn't be true.
...
const zooAnimals = [
  ...
  */
  ...
  console.log('TEST 1',animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseNames =array.map(function(element){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const endangeredAnimals = array.filter(function(element){
  ...
  */
  ...
  console.log('TEST 4',USApop(zooAnimals));
